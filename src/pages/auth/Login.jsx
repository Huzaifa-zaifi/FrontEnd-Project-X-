    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 bg-white flex items-center justify-center p-10 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <h3 className="text-4xl font-bold text-[#1F2937] mb-2">Welcome Back</h3>
          <p className="text-[#6B7280] mb-8">Let's Login to your Redvion Account</p>

          {/* Social Login Buttons */}
          <div className="flex flex-col gap-3 mb-6">
            <button
              onClick={() => handleSocialLogin('Apple')}
              className="flex items-center justify-center gap-3 w-full py-3.5 px-5 border-2 border-[#E5E7EB] rounded-xl bg-white text-[#1F2937] text-base font-medium hover:border-[#6B46C1] hover:bg-[#F9FAFB] transition-all"
            >
          ...
          <div className="text-center mt-8">
            <p className="text-[#6B7280] text-sm">
              ...
              <Link to="/signup" className="text-[#6B46C1] font-semibold hover:text-[#5B21B6] hover:underline transition-colors">
                Create Account
              </Link>
            </p>
          </div>
